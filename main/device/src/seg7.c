...
static inline void clk_high(seg7_t *dev) {
    gpio_ll_set_level(dev->hw, dev->clk, 1);
}

static inline void clk_low(seg7_t *dev) {
    gpio_ll_set_level(dev->hw, dev->clk, 0);
}
...
static inline void dio_high(seg7_t *dev) {
    gpio_ll_set_level(dev->hw, dev->dio, 1);
}

static inline void dio_low(seg7_t *dev) {
    gpio_ll_set_level(dev->hw, dev->dio, 0);
}
