...
int sensor_add(const char *name, const char *unique_id,
    const char *component_type, const char *device_class, const char *unit,
    const char *icon, const char *payload_on, const char *payload_off,
    value_type_t type) {
